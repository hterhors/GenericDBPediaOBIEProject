package de.hterhors.obie.projects.dbpedia.ie.templates;
...
import de.hterhors.obie.projects.dbpedia.ie.templates.EmptyTemplate.Scope;
...
public class EmptyTemplate extends AbstractOBIETemplate<Scope> {
	...
	public List<Scope> generateFactorScopes(OBIEState state) {
		...
		for (TemplateAnnotation templateAnnotation : state.getCurrentTemplateAnnotations().getTemplateAnnotations()) {
			...
			IOBIEThing soccerPlayer = templateAnnotation.getThing();
			/*

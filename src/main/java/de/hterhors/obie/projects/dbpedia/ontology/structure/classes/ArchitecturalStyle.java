...
@DirectInterface(get=IArchitecturalStyle.class)

@SuperRootClasses(get={ArchitecturalStyle.class, })

@AssignableSubClasses(get={})
 public class ArchitecturalStyle implements IArchitecturalStyle{

final public static IndividualFactory<ArchitecturalStyleIndividual> individualFactory = new IndividualFactory<>();
final public static Class<? extends AbstractIndividual> individualClassType = ArchitecturalStyleIndividual.class;
static class ArchitecturalStyleIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public ArchitecturalStyleIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "ArchitecturalStyleIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<ArchitecturalStyleIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final ArchitecturalStyleIndividual individual;
	@Override
...
return false;
ArchitecturalStyle other = (ArchitecturalStyle) obj;
if (individual == null) {

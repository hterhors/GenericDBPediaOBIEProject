...
static class OrganisationIndividual extends AbstractIndividual {
	...
	@Override
	public Organisation setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://dbpedia.org/ontology/Organisation";
...
this.investigationRestriction = organisation.investigationRestriction;
...
this.textMention = organisation.getTextMention();
	...
	public Organisation(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
@Override
public String toString(){
return "Organisation [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}

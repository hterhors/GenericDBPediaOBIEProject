...
@DirectInterface(get=IYearOfConstruction.class)

@AssignableSubClasses(get={})

@DatatypeProperty public class YearOfConstruction implements IYearOfConstruction{
...
return false;
YearOfConstruction other = (YearOfConstruction) obj;

...
final public static Class<? extends AbstractIndividual> individualClassType = MusicalArtistIndividual.class;
static class MusicalArtistIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public MusicalArtistIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "MusicalArtistIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<MusicalArtistIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final MusicalArtistIndividual individual;
	@Override

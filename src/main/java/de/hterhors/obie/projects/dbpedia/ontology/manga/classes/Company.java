...
final public static Class<? extends AbstractIndividual> individualClassType = CompanyIndividual.class;
static class CompanyIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public CompanyIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "CompanyIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<CompanyIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final CompanyIndividual individual;
	@Override

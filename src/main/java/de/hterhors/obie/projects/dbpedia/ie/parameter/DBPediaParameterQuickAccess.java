...
public class DBPediaParameterQuickAccess {

	public static Builder getREParameter(Class<? extends IOBIEThing> _corpusType) {
		/**
		 ...
		 * 
		 */
		final Class<? extends IOBIEThing> corpusType = _corpusType;
		 ...
		 *
		 */
		final Class<? extends IOBIEThing> searchType = corpusType;
